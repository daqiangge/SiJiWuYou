...
@property (strong, nonatomic) ForgetPWVM *viewModel;

@end

@implementation ForgetPWCell
...
- (void)bindViewModel:(ForgetPWVM *)viewModel {
...
- (void)configureButton {
    [self configureBorder:_forgetButton];
}
...
- (IBAction)forgetPW:(id)sender {
    ...
    if (_delegate) {
        if ([_delegate respondsToSelector:@selector(forgetPW)]) {
            [_delegate forgetPW];
        }
    }
}
